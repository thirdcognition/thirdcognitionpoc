...
from lib.db.source import db_source_exists, get_db_sources, update_db_source_rag
...
# Construct the graph
# Nodes:
find_topics_graph = StateGraph(ProcessTextState, ProcessTextConfig)
find_topics_graph.add_node("split_content", split_content)
...
find_topics_graph.add_node("get_source_content", get_source_content)
# find_topics_graph.add_node("collapse_content", collapse_content)
find_topics_graph.add_node("finalize_content", finalize_content)
find_topics_graph.add_node("rag_content", rag_content)

# Edges:
find_topics_graph.add_conditional_edges(START, should_rewrite_content)
# find_topics_graph.add_edge(START, "split_content")
...
find_topics_graph.add_edge("concat_reformat", "finalize_content")
# find_topics_graph.add_conditional_edges("concat_reformat", should_collapse)
# find_topics_graph.add_edge("collapse_content", "finalize_content")
find_topics_graph.add_edge("get_source_content", "finalize_content")

find_topics_graph.add_conditional_edges("finalize_content", should_rag)
find_topics_graph.add_edge("rag_content", END)
