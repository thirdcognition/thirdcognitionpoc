...
from lib.models.journey import TaskStructure, ModuleStructure
...
class TeachingTask(BaseModel):
    ...
    parent_section: ModuleStructure = Field(description="Parent subject the teaching task is part of")
