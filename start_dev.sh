...
streamlit run poctimeline/admin/Admin_Home.py --server.port 5000 --server.headless true --server.address=0.0.0.0 --client.showErrorDetails=False --client.toolbarMode=minimal --server.fileWatcherType=none &
